---
layout: post
title: "Comparing cities by climate"
---

We analyze data from <https://darksky.net> from the last 10 years to compare
climates in a selection of North American cities.
...
* the cloud cover (daily value) is at most 70%, and
* the UV index (daily value) is at most moderate,

<!-- UV index seems like a daily max because there's uvIndexTime, cloud cover
doesn't have a cloudCoverTime but it's ok even if it's instantaneous -->
...
See also: <https://myperfectweather.com/>
